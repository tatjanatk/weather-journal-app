...
function performAction(e) {
    ...
    console.log(city);
    const feelings = document.getElementById("feelings").value.toString();
...
const updateUI = async () => {
    ...
    try {
        ...
        cityName.innerHTML = "<b>" + allData.city + "</b>";
        icon.src = "http://openweathermap.org/img/w/"+ allData.icon + ".png";
        temp.innerHTML = allData.temp + " C°";
        content.innerHTML =  allData.content;
        document.getElementById("divider").style.visibility = "visible";
        feels.innerHTML = "<b>Feelings:</b> " + allData.feelings;
